...
import { CreateCompanyMembersView } from '../../../../components/company/create-company/steps/members';
...
const CreateCompanyProfile: NextPage<Props> = ({ companySlug, step }) => {
  ...
  return <CreateCompanyMembersView step={step} companySlug={companySlug} />;
};
...
CreateCompanyProfile.getInitialProps = async (ctx: NextPageContextApollo) => {
  ...
  const companySetup = createCompanySteps.find(
    setup => setup.title.toLowerCase() === 'members',
  );
