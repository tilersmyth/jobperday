...
import { CreateCompanyContactView } from '../../../../components/company/create-company/steps/contact';
...
const CreateCompanyContact: NextPage<Props> = ({ companySlug, step }) => {
  if (!companySlug || !step) {
    return null;
  }

  return <CreateCompanyContactView step={step} companySlug={companySlug} />;
};

CreateCompanyContact.getInitialProps = async (ctx: NextPageContextApollo) => {
