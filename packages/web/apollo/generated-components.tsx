...
export type Mutation = {
  ...
  createJob: JobDto;
  addJobPosting: Scalars['Boolean'];
  addJobPostingAddress: Scalars['Boolean'];
};
...
export type MutationAddJobPostingArgs = {
  input: AddJobPostingInput;
};

export type MutationAddJobPostingAddressArgs = {
